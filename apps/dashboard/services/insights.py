...
SUBCATEGORY_MAP = {
    'Качество блюд': 'Вкус/качество еды',
    'Скорость обслуживания': 'Скорость обслуживания',
    'Сервис в целом': 'Отношение персонала',
    'Атмосфера и интерьер': 'Атмосфера',
    'Цены': 'Цены',
    'Бронирование и посадка': 'Бронирование',
    'Пищевая безопасность': 'Безопасность еды',
